...
# sudo apt install grub-customizer ffmpeg synaptic vifm rtorrent moc arc kate kcalc okular vim git curl wget mpv yakuake gwenview kipi-plugins kde-spectacle ttf-ubuntu-font-family -y

# debianBuster BSPWM
sudo apt install grub-customizer ffmpeg vifm rtorrent moc ark vim git curl wget mpv ttf-ubuntu-font-family -y
